...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		Color a1 = new Color(0, 109, 219);
		StdDraw.setPenColor(a1);
		double r1=3.0/4.0*radius;
		StdDraw.filledCircle(x, y, r1);

		

		// Red ring with 1.0/2.0 the radius
		// suggested rgb values: 146, 0, 0
		Color a2 = new Color(146, 0, 0);
		StdDraw.setPenColor(a2);
		double r2=1.0/2.0*radius;
		StdDraw.filledCircle(x, y, r2);
		...
		Color a3 = new Color(255, 255, 109);
		StdDraw.setPenColor(a3);
		double r3=1.0/4.0*radius;
		StdDraw.filledCircle(x, y, r3);
